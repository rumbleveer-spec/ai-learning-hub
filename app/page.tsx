    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      <nav className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-primary">📚 Learning Hub AI</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 py-20 text-center">
        <h2 className="text-5xl font-extrabold text-gray-900 dark:text-white mb-6">Learning Hub AI</h2>
      ...
      <footer className="bg-gray-900 text-gray-300 py-8 mt-24 text-center">
        <p>&copy; 2024 Learning Hub AI. Built with Next.js & AI</p>
      </footer>
    </div>
  );
}
